...
public class TissueBox extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tissuebox);
        btn_calculate = (Button) findViewById(R.id.btn_calculatetb);
        final EditText et3 = (EditText) findViewById(R.id.cubefeettb);
        final EditText et4 = (EditText) findViewById(R.id.woodwidthtb);
        final EditText et5=(EditText)findViewById(R.id.squarefeettb);
        final String a = et3.getText().toString();
        final String b = et4.getText().toString();
        final String c = et5.getText().toString();
        final CheckBox nwtop=(CheckBox)findViewById(R.id.newwoodtoptb);
        final  CheckBox nwbottom=(CheckBox)findViewById(R.id.newwoodbottomtb);
        final CheckBox nwleft=(CheckBox)findViewById(R.id.newwoodlefttb);
        final  CheckBox nwright=(CheckBox)findViewById(R.id.newwoodrighttb);
        final CheckBox nwfront=(CheckBox)findViewById(R.id.newwoodfronttb);
        final CheckBox nwback=(CheckBox)findViewById(R.id.newwoodbacktb);
        final  CheckBox wtop=(CheckBox)findViewById(R.id.woodtoptb);
        final CheckBox wbottom=(CheckBox)findViewById(R.id.woodbottomtb);
        final CheckBox wleft=(CheckBox)findViewById(R.id.woodlefttb);
        final CheckBox wright=(CheckBox)findViewById(R.id.woodrighttb);
        final CheckBox wfront=(CheckBox)findViewById(R.id.woodfronttb);
        final CheckBox wback=(CheckBox)findViewById(R.id.woodbacktb);
        ...
        btn_calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EditText et = (EditText) findViewById(R.id.Lengthtb);
                String x = et.getText().toString();

                EditText et1 = (EditText) findViewById(R.id.Breadthtb);
                String y = et1.getText().toString();

                EditText et2 = (EditText) findViewById(R.id.Heighttb);
                String z = et2.getText().toString();

                EditText et3 = (EditText) findViewById(R.id.cubefeettb);
                String a = et3.getText().toString();

                EditText et4 = (EditText) findViewById(R.id.woodwidthtb);
                String b = et4.getText().toString();
                EditText et5=(EditText)findViewById(R.id.squarefeettb);
                String c=et5.getText().toString();
                TextView totalPrice = (TextView) findViewById(R.id.total_pricetb);
                int TotalChecks=0;
                for(int i=0;i<6;i++)
