...
public class HutBox extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hutbox);
        ...
        btn_calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText et6=(EditText)findViewById(R.id.taperwidth);
                ...
                if(TotalChecks!=6){
                    ...
                    if (x.equals("") || y.equals("") || z.equals("") || a.equals("") || b.equals("")||c.equals("")) {
                        ...
                        double Tw= Double.parseDouble(d);
                        double Cf=0;
                        double Ww=0;
                        if(W[0]==1||W[1]==1||W[2]==1||W[3]==1||W[4]==1||W[5]==1)
                        ...
                        double price =(((W[0]*2*L*Tw+W[1]*L*B+W[2]*B*H+W[3]*B*H+W[4]*L*H+W[5]*L*H)*Cf*Ww)/1728)+
                                (((Nw[0]*2*L*Tw+Nw[1]*L*B+Nw[2]*B*H+Nw[3]*B*H+Nw[4]*L*H+Nw[5]*L*H)*Sf)/144) ;
