...
public class CandleHolder extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.candleholder);
            ...
            public void onClick(View v) {
                ...
                if(TotalChecks!=6){
                    ...
                    if (x.equals("") || y.equals("") || z.equals("") || a.equals("") || b.equals("")||c.equals("")) {
                        ...
                        double price =(((W[0]*(L+1)*(B+1)+W[1]*(L+1)*(B+1)+W[2]*B*H+W[3]*B*H+W[4]*L*H+W[5]*L*H)*Cf*Ww)/1728)+
                                (((Nw[0]*(L+1)*(B+1)+Nw[1]*(L+1)*(B+1)+Nw[2]*B*H+Nw[3]*B*H+Nw[4]*L*H+Nw[5]*L*H)*Sf)/144) ;
