...
public class Coaster extends AppCompatActivity  {
    int nox=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.coaster);
        ...
        final ImageView ima=(ImageView)findViewById(R.id.coasterimage);
        ...
        no.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(no.isChecked())
                {
                    ...
                    nox=1;
                    ima.setImageResource(R.drawable.coasterwithouttop);
                }
                else
                {
                    nox=0;
        ...
        nwtop.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonview,boolean isChecked) {
                if(isChecked){
                    ...
                    wtop.setChecked(false);
                    no.setChecked(false);
                    ima.setImageResource(R.drawable.coasterwithtop);
                }
                else{
                    Nw[0]=0;
                }
        ...
        btn_calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText et6=(EditText)findViewById(R.id.numberofplates);
                String d=et6.getText().toString();

                EditText et7=(EditText)findViewById(R.id.plateplywoodrate);
                String e=et7.getText().toString();
                ...
                if(TotalChecks<6){
                    ...
                    if (x.equals("") || y.equals("") || z.equals("") || a.equals("") || b.equals("")||c.equals("")||e.equals("")||d.equals("")) {
                        ...
                        double noOfplates=Double.parseDouble(d);
                        double platePlywoodRate=Double.parseDouble(e);
                        double Cf=0;
                        double Ww=0;
                        if(W[0]==1||W[1]==1||W[2]==1||W[3]==1||W[4]==1||W[5]==1)
                     ...
                     double price=0;
                        price+=(((W[0]*L*B+W[1]*L*B+W[2]*B*H+W[3]*B*H+W[4]*L*H+W[5]*L*H)*Cf*Ww)/1728)+
                                (((Nw[0]*L*B+Nw[1]*L*B+Nw[2]*B*H+Nw[3]*B*H+Nw[4]*L*H+Nw[5]*L*H)*Sf)/144) ;
                        price+=((L-2*Ww)*(B-2*Ww))*(noOfplates*platePlywoodRate)/144;
