...
public class Tray extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CheckBox simple=(CheckBox)findViewById(R.id.simple);
        final CheckBox taper =(CheckBox)findViewById(R.id.taper);
        ...
        final TextView et1=(TextView) findViewById(R.id.Height1);
        final ImageView im=(ImageView)findViewById(R.id.trayimage);
        ...
        simple.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(simple.isChecked())
                {
                    simpletaper[0]=1;
                    simpletaper[1]=0;
                    taper.setChecked(false);
                    et1.setText("Height{H}: ");
                    im.setImageResource(R.drawable.tray1);
                }
                else
                {
                    simpletaper[0]=0;
                    et1.setText("Taper Height{TH}: ");
                }
        ...
        taper.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(taper.isChecked())
                {
                    ...
                    et1.setText("Taper Height{TH}: ");
                    im.setImageResource(R.drawable.tapertray);
                }
                else
                {
                    simpletaper[1]=0;
        ...
        nwbottom.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonview,boolean isChecked) {
                ...
                if(W[1]==1||W[2]==1||W[3]==1||W[4]==1||W[5]==1)
                {
                ...
                if(Nw[1]==1||Nw[2]==1||Nw[3]==1||Nw[4]==1||Nw[5]==1)
                {
                    et5.setEnabled(true);
                    et5.setText("");
                }
        ...
        nwback.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonview,boolean isChecked) {
                ...
                if(Nw[2]==1||Nw[3]==1||Nw[4]==1||Nw[5]==1)
                {
                    et5.setEnabled(true);
                    et5.setText("");
                }
        ...
        btn_calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TotalChecks+=simpletaper[0]+simpletaper[1];
                if(TotalChecks!=6){
                    ...
                    if (x.equals("") || y.equals("") || z.equals("") || a.equals("") || b.equals("")||c.equals("")) {
                        ...
                        double price =(((W[1]*L*B+W[2]*B*H+W[3]*B*H+W[4]*L*H+W[5]*L*H)*Cf*Ww)/1728)+
                                (((Nw[1]*L*B+Nw[2]*B*H+Nw[3]*B*H+Nw[4]*L*H+Nw[5]*L*H)*Sf)/144) ;
